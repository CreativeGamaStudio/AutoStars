    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                ...
                return '<a class="btn btn-xs btn-primary" data-bs-toggle="modal" data-bs-target="#modal-edit-registration" data-bs-registration="' . $itemasjson . '"><i class="fas fa-eye"></i> Edit</a>';
            })
            ->setRowId('id');
    }

...
@section('content')
    ...
    {{-- script edit --}}
    <script>
        var exampleModal = document.getElementById('modal-edit-return')
        exampleModal.addEventListener('show.bs.modal', function(event) {
            ...
            try {
                ...
                var inputDate = document.getElementById('modal-edit-return').querySelector('#date');
                ...
                // set action to form
                var modalForm = document.getElementById('modal-edit-return').querySelector('form');
                modalForm.action = "/return_notes/" + json.id;
    ...
    <x-modal id="modal-delete-return" size="sm">
    ...
    {{-- script delete --}}
    <script>
        var exampleModal = document.getElementById('modal-delete-return')
